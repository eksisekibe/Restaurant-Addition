            ...
            while (dr.Read())
            {
                foreach (Control item in this.Controls)
                {
                    if (item is Button)
                    {
                        ...
                        {
                            item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.masaicon);
                        }
                        ...
                        {
                            item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.acıkrezervemasa);

                        }
                        else if (item.Name == "btnMasa" + dr["ID"].ToString() && dr["DURUM"].ToString() == "4")
                        {
                            item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.rezervemasa);
